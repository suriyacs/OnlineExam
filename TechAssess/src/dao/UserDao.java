...
/**
 * <p>
 *     This class provide interface between database and Service class. insert User
 *     Details from Service class into database and also perform retrieve User
...
public class UserDao {
    ...
    /**
     * <p>
     *     Retrieve all Users Details from Database in List format and send this
     *     list back to Service Class.
     * </p>
     * 
     * @return List 
     *     Contains instance of all Users in form of list.
    ...
    public List<User> retrieveAllUser()
            throws DataException { /* To populate employee */
    ...
    /**
     * <p>
     *     Gets User model Object from Service class which contains details of Exam
     *     and create the session then begin the transaction persist the user object
     *     and close the session returns id after insertion of user into database.
     * </p>
     * 
     * @param user
     *     Contains an instance of User.
     * @throws DataException
     *     Throws an exception if any Hibernate Exception raised during
     *     database connection.
     */
    public void insertUser(User user) throws DataException {
        ...
        try {
            ...
            throw new DataException(
                    "Error occured while adding your details. Kindly provide proper details or try again sometime");
        } finally {
            session.close();
        }
    }
    ...
    /**
     * <p>
     *     Retrieves the User Details of particular emmailId from database and
     *     return this details to Service class
     * </p>
     * 
     * @param emailId
