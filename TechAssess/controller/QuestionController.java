...
public class QuestionController {
     ...
     * questiontype by calling allocateQuestionType method of questionService
    ...
    public String addQuestionForChooseTheBest(@ModelAttribute("Question") Question question, ModelMap model,
        ...
        try {
            ...
            for (Choice choice : question.getChoices()) {
                choiceService.allocateQuestion(choiceService.addChoice(choice.getChoiceName(), (choice.getIsCorrect())),
                        questionId);
            }
